 ...
 * C source code generated on : Mon Mar  8 10:26:04 2021
 *
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } Optimaluu_PWORK;                   /* '<Root>/Optimal u (u*)' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } Optimalstatesx_PWORK;              /* '<Root>/Optimal states (x*)' */
  ...
  struct {
    int_T PrevIndex;
  } Optimaluu_IWORK;                   /* '<Root>/Optimal u (u*)' */

  struct {
    int_T PrevIndex;
  } Optimalstatesx_IWORK;              /* '<Root>/Optimal states (x*)' */
...
struct P_helicopter_T_ {
  ...
  real_T elevation_ref_Value;          /* Expression: 0
                                        * Referenced by: '<S1>/elevation_ref'
                                        */
 ...
 *
 * '<Root>' : 'helicopter'
 * '<S1>'   : 'helicopter/Basic control layer'
 * '<S2>'   : 'helicopter/Degrees to Radians'
 * '<S3>'   : 'helicopter/LQR'
 * '<S4>'   : 'helicopter/Plant (Helicopter)'
 * '<S5>'   : 'helicopter/Basic control layer/Elevation controller'
 * '<S6>'   : 'helicopter/Basic control layer/Pitch controller'
 * '<S7>'   : 'helicopter/Basic control layer/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopter/Plant (Helicopter)/Conversion'
 * '<S9>'   : 'helicopter/Plant (Helicopter)/Helicopter_interface'
 * '<S10>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Elevation rad to deg'
 * '<S11>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Elevation rate rad to deg'
 * '<S12>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Pitch rad to deg'
 * '<S13>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Pitch rate rad to deg'
 * '<S14>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Pitch rate rad to deg1'
 * '<S15>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Travel rad to deg'
 * '<S16>'  : 'helicopter/Plant (Helicopter)/Helicopter_interface/Travel rate  rad to deg'
 */
