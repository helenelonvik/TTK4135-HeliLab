...
#ifndef RTW_HEADER_helicopterOppg4_h_
#define RTW_HEADER_helicopterOppg4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopterOppg4_COMMON_INCLUDES_
#define helicopterOppg4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopterOppg4_COMMON_INCLUDES_ */

#include "helicopterOppg4_types.h"
...
#define helicopterOppg4_rtModel        RT_MODEL_helicopterOppg4_T
...
#define rtB                            helicopterOppg4_B
#define BlockIO                        B_helicopterOppg4_T
#define rtX                            helicopterOppg4_X
#define ContinuousStates               X_helicopterOppg4_T
#define rtXdot                         helicopterOppg4_XDot
#define StateDerivatives               XDot_helicopterOppg4_T
#define tXdis                          helicopterOppg4_XDis
#define StateDisabled                  XDis_helicopterOppg4_T
#define rtP                            helicopterOppg4_P
#define Parameters                     P_helicopterOppg4_T
#define rtDWork                        helicopterOppg4_DW
#define D_Work                         DW_helicopterOppg4_T

/* Parameters (default storage) */
struct P_helicopterOppg4_T_ {
...
struct tag_RTM_helicopterOppg4_T {
  const char_T *path;
...
extern P_helicopterOppg4_T helicopterOppg4_P;

/* Block signals (default storage) */
extern B_helicopterOppg4_T helicopterOppg4_B;

/* Continuous states (default storage) */
extern X_helicopterOppg4_T helicopterOppg4_X;

/* Block states (default storage) */
extern DW_helicopterOppg4_T helicopterOppg4_DW;

/* Model entry point functions */
extern void helicopterOppg4_initialize(void);
extern void helicopterOppg4_output(void);
extern void helicopterOppg4_update(void);
extern void helicopterOppg4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopterOppg4_rtModel *helicopterOppg4(void);
...
extern RT_MODEL_helicopterOppg4_T *const helicopterOppg4_M;
 ...
 *
 * '<Root>' : 'helicopterOppg4'
 * '<S1>'   : 'helicopterOppg4/Conversion'
 * '<S2>'   : 'helicopterOppg4/Degrees to Radians'
 * '<S3>'   : 'helicopterOppg4/Elevation controller'
 * '<S4>'   : 'helicopterOppg4/Elevation controller1'
 * '<S5>'   : 'helicopterOppg4/Helicopter_interface'
 * '<S6>'   : 'helicopterOppg4/Pitch controller'
 * '<S7>'   : 'helicopterOppg4/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopterOppg4/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopterOppg4/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopterOppg4/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopterOppg4/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopterOppg4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopterOppg4/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopterOppg4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopterOppg4_h_ */
