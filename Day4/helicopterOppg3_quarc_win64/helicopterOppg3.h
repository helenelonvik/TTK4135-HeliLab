...
#ifndef RTW_HEADER_helicopterOppg3_h_
#define RTW_HEADER_helicopterOppg3_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopterOppg3_COMMON_INCLUDES_
#define helicopterOppg3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopterOppg3_COMMON_INCLUDES_ */

#include "helicopterOppg3_types.h"
...
#define helicopterOppg3_rtModel        RT_MODEL_helicopterOppg3_T
...
#define rtB                            helicopterOppg3_B
#define BlockIO                        B_helicopterOppg3_T
#define rtX                            helicopterOppg3_X
#define ContinuousStates               X_helicopterOppg3_T
#define rtXdot                         helicopterOppg3_XDot
#define StateDerivatives               XDot_helicopterOppg3_T
#define tXdis                          helicopterOppg3_XDis
#define StateDisabled                  XDis_helicopterOppg3_T
#define rtP                            helicopterOppg3_P
#define Parameters                     P_helicopterOppg3_T
#define rtDWork                        helicopterOppg3_DW
#define D_Work                         DW_helicopterOppg3_T

/* Parameters (default storage) */
struct P_helicopterOppg3_T_ {
...
struct tag_RTM_helicopterOppg3_T {
  const char_T *path;
...
extern P_helicopterOppg3_T helicopterOppg3_P;

/* Block signals (default storage) */
extern B_helicopterOppg3_T helicopterOppg3_B;

/* Continuous states (default storage) */
extern X_helicopterOppg3_T helicopterOppg3_X;

/* Block states (default storage) */
extern DW_helicopterOppg3_T helicopterOppg3_DW;

/* Model entry point functions */
extern void helicopterOppg3_initialize(void);
extern void helicopterOppg3_output(void);
extern void helicopterOppg3_update(void);
extern void helicopterOppg3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopterOppg3_rtModel *helicopterOppg3(void);
...
extern RT_MODEL_helicopterOppg3_T *const helicopterOppg3_M;
 ...
 *
 * '<Root>' : 'helicopterOppg3'
 * '<S1>'   : 'helicopterOppg3/Conversion'
 * '<S2>'   : 'helicopterOppg3/Degrees to Radians'
 * '<S3>'   : 'helicopterOppg3/Elevation controller'
 * '<S4>'   : 'helicopterOppg3/Helicopter_interface'
 * '<S5>'   : 'helicopterOppg3/Pitch controller'
 * '<S6>'   : 'helicopterOppg3/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopterOppg3/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopterOppg3/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopterOppg3/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopterOppg3/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopterOppg3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopterOppg3/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopterOppg3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopterOppg3_h_ */
